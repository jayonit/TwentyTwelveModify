...
function twentytwelve_get_font_url() {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'twentytwelve' ) ) {
		...
		$font_url = add_query_arg( $query_args, 'https://cdn.css.net/fonts/css' );
	}
...
$maxitems = $rss->get_item_quantity( 3 ); //抓取最新3篇文章
...
$output .= '<div class="friend-posts"><h4 class="friend-posts-title"><a style="display:block" href="' . $bookmark->link_url . '" title="' . $bookmark->link_description . '" target="_blank" >'. get_avatar($bookmark->link_notes,48) . $bookmark->link_name .'</a></h4>';
